...
libmm-venc-inc      += hardware/qcom/media-caf/$(TARGET_BOARD_PLATFORM)/mm-core/inc
libmm-venc-inc      += hardware/qcom/media-caf/$(TARGET_BOARD_PLATFORM)/libstagefrighthw
libmm-venc-inc      += $(TARGET_OUT_HEADERS)/qcom/display
libmm-venc-inc      += $(TARGET_OUT_HEADERS)/adreno
libmm-venc-inc      += frameworks/native/include/media/hardware
libmm-venc-inc      += frameworks/native/include/media/openmax
libmm-venc-inc      += hardware/qcom/media-caf/$(TARGET_BOARD_PLATFORM)/libc2dcolorconvert
