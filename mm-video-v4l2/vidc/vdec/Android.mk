...
libmm-vdec-inc          += $(TOP)/hardware/qcom/media-caf/$(TARGET_BOARD_PLATFORM)/mm-core/inc
...
libmm-vdec-inc      	+= $(TOP)/hardware/qcom/media-caf/$(TARGET_BOARD_PLATFORM)/libc2dcolorconvert
...
libmm-vdec-inc += $(TOP)/hardware/qcom/media-caf/$(TARGET_BOARD_PLATFORM)/libstagefrighthw
endif
